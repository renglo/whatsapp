...
'''
    USAGE
    python upload_blueprints.py x --aws-profile maker --aws-region us-east-1  
    python upload_blueprints.py x --aws-profile maker --blueprint --aws-region us-east-1  claw_beliefs
'''
